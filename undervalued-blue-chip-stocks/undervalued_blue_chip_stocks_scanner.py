...
def enhanced_valuation_screener():
    ...
    with pd.ExcelWriter(out_name, engine='openpyxl') as writer:
        ...
        # 📋 열 설명 시트 추가
        column_explanations = [
            {'열 이름': 'Ticker', '의미': '종목코드', '설명': '주식 시장에서 사용하는 고유 기호'},
            {'열 이름': 'Name', '의미': '회사명', '설명': '상장회사 공식 명칭'},
            {'열 이름': 'Sector', '의미': '업종/섹터', '설명': '기술, 헬스케어, 금융 등 산업 분류'},
            {'열 이름': 'Price', '의미': '현재 주가', '설명': '현재 시장에서 거래되는 주식 가격'},
            {'열 이름': 'FairValue_Composite', '의미': '종합 적정가', '설명': '여러 가치 평가 모델을 종합하여 계산한 공정 가치'},
            {'열 이름': 'Discount_Pct', '의미': '할인율 (%)', '설명': '적정가 대비 현재 주가가 낮은 정도, 양수면 저평가'},
            {'열 이름': 'MktCap($B)', '의미': '시가총액 (10억 달러)', '설명': '회사의 전체 시장 가치'},
            {'열 이름': 'PE', '의미': '주가수익비율', '설명': '주가를 주당순이익으로 나눈 값, 낮을수록 저평가'},
            {'열 이름': 'PEG', '의미': '주가수익비율 성장률 배수', '설명': 'PER을 성장률로 나눈 값, 1 이하가 이상적'},
            {'열 이름': 'EV_EBITDA', '의미': '기업가치 대비 EBITDA 비율', '설명': '기업 인수 비용 대비 영업이익'},
            {'열 이름': 'FCF_Yield', '의미': '자유현금흐름 수익률', '설명': '주가 대비 자유현금흐름 비율, 높을수록 좋음'},
            {'열 이름': 'ROE(info)', '의미': '자기자본이익률', '설명': '자본 대비 순이익률, 수익성 지표'},
            {'열 이름': 'Debt_to_Equity', '의미': '부채비율', '설명': '자본 대비 부채 비율, 낮을수록 재무건전성 좋음'},
            {'열 이름': 'DivYield', '의미': '배당수익률', '설명': '주가 대비 배당금 비율'},
            {'열 이름': 'GrowthScore', '의미': '성장성 점수', '설명': '매출 성장, 수익 성장 등 성장성 종합 점수'},
            {'열 이름': 'QualityScore', '의미': '질 점수', '설명': '수익성, 재무건전성, 경영 효율성 종합 점수'},
            {'열 이름': 'ValueScore', '의미': '가치 점수', '설명': '저평가 정도, 다양한 가치 지표 종합 점수'},
            {'열 이름': 'TotalScore', '의미': '종합 총점', '설명': '성장성 + 질 + 가치 점수의 가중합'},
            {'열 이름': 'ValuationAdjustedScore', '의미': '가치 조정 종합점수', '설명': '종합 총점에 할인율을 추가 반영한 최종 점수'},
            {'열 이름': 'ModernBuffettScore', '의미': '현대적 버핏 점수', '설명': '경제적 해자, 현금흐름 안정성 등 현대적 버핏 요소 점수'},
            {'열 이름': 'TotalScore_Modern', '의미': '현대적 버핏 종합점수', '설명': '현대적 버핏 철학을 반영한 최종 점수'},
            {'열 이름': 'DollarVol($M)', '의미': '달러 거래량 (백만 달러)', '설명': '하루 거래 대금, 클수록 유동성 좋음'},
            {'열 이름': 'RVOL', '의미': '상대 거래량', '설명': '평균 대비 거래량 비율 (1.0 = 평균)'},
            {'열 이름': 'ATR_PCT', '의미': '평균 실제 범위 (%)', '설명': '주가 변동성 크기, 높을수록 등락 심함'},
            {'열 이름': 'SMA20', '의미': '20일 이동평균', '설명': '단기 추세선'},
            {'열 이름': 'SMA50', '의미': '50일 이동평균', '설명': '중기 추세선'},
            {'열 이름': 'RET5', '의미': '5일 수익률', '설명': '최근 5일간 주가 등락율'},
            {'열 이름': 'RET20', '의미': '20일 수익률', '설명': '최근 20일간 주가 등락율'},
            {'열 이름': 'MomentumScore', '의미': '모멘텀 점수', '설명': '단기 주가 추세 강도 (최근 상승력)'},
            {'열 이름': 'TrendScore', '의미': '트렌드 점수', '설명': '장기 추세 방향성 (상승/하락/횡보)'},
            {'열 이름': 'LiquidityScore', '의미': '유동성 점수', '설명': '매매 용이성 (거래량, 거래대금 종합)'},
            {'열 이름': 'VolatilityScore', '의미': '변동성 점수', '설명': '적정 변동성 (너무 낮거나 높지 않은 적정 수준)'},
        ]

        pd.DataFrame(column_explanations).to_excel(writer, sheet_name='열_설명', index=False)
